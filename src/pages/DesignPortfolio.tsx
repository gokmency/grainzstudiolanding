        ...
        <div className="max-w-7xl mx-auto">
          <div className="mb-16">
            ...
            <p className="font-manrope text-sm text-white/85 max-w-[600px]">
              Every design is crafted to leave a lasting impression. From brand identity to digital experiences, we create visual narratives that resonate deeply with your audience.
            </p>
          </div>
